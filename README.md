...
An [OpenResty](https://openresty.org/)-based echo server for proxy and HTTP client testing. You will find comprehensive documentation at [this](https://chamber.wilhelm.codes) dedicated website.