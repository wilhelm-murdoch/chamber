...
Exposes a websocket server endpoint used for echoing back data for testing.
...
Finally, you can use this endpoint to perform end-to-end testing with a browser-based client. There are plenty of libraries out there to get you started.
